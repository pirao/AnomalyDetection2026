...
scenario using the current slider values. Consumer: ``notebooks/1.02-acp-model-debugging.ipynb``.
"""
...
from ._scoring_payload import _FastPayloadKey, build_sigmoid_scoring_payload_fast
